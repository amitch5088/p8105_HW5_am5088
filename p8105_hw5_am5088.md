...
wpost_homicide_data = read_csv("https://raw.githubusercontent.com/washingtonpost/data-homicides/master/homicide-data.csv")
```
...
``` r
wpost_homicide_data = wpost_homicide_data %>%
...
``` r
city_data_summary = wpost_homicide_data %>%
  mutate(
